...
public class ReserveApi {
    ...
    public List<ReserveSubsidiaryRequest> getSubsidiaryListPharmacies(@PathVariable String subsidiaryId,
                                                            @RequestParam Integer page,
                                                            @RequestParam Integer size,
                                                            @RequestParam Integer state){
        List<ReserveSubsidiaryRequest> product = reserveBl.getSubsidiaryListReserve(Integer.parseInt(subsidiaryId), page, size,state);
        return product;
    }
    ...
    public List<ProductReserveRepRequest> getSubsidiaryListReportGeneralPharmacies(@PathVariable String subsidiaryId,
        ...
        List<ProductReserveRepRequest> product = reserveBl.getSubsidiaryListReportGeneralReserve(Integer.parseInt(subsidiaryId), page, size,asc);
        return product;
    }
}
